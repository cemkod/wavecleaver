...
// SaveWithFilter behaves like Save but also returns the 0-based index of the
// active file filter chosen by the user, or -1 if it could not be determined.
func (b *FileBuilder) SaveWithFilter() (string, int, error) {
	return b.saveWithFilter()
}
